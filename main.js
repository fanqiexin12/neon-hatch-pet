...
function buildPetMenu(win, menuState) {
  ...
  if (hatched) {
    template.push(
      ...
      { label: "击掌", click: () => sendPetCommand(win, "highFive") },
      { label: "唱歌", click: () => sendPetCommand(win, "sing") },
      ...
      { label: `陪伴日记：${memory.journalCount || 0} 条`, click: () => sendPetCommand(win, "openJournalPanel") },
